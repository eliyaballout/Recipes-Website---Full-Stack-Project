...
async function markAsFamilyRecipe(recipe_id, user_id, owner, whenToPrepare, title, readyInMin, vegetarian, vegan, glutenFree, image, instructions, ingredients) {
  await DButils.execQuery(`INSERT INTO family_recipes VALUES (${recipe_id},${user_id},'${owner}','${whenToPrepare}','${title}',${readyInMin},${vegetarian},${vegan},${glutenFree},${image},'${instructions}','${JSON.stringify(ingredients)}')`);
}
